...
async function createPhotoOxy(url, text) {
    try {
        ...
        if (!resultUrl) throw new Error("Could not find image URL from PhotoOxy response.");
        return resultUrl;
    } catch (error) {
...
async function createTextPro(url, text) {
    try {
        ...
        const post = await axios.post('https://textpro.me/effect/create-effect', new URLSearchParams({
            'text[]': text,
            'submit': 'Go',
            token,
            build_server,
        ...
        if (!result || !result.fullsize_image) throw new Error("Could not get image URL from TextPro response.");
...
module.exports = {
    ...
    async execute(sock, m, args) {
        ...
        const styles = {
            ...
            naruto: { api: 'photooxy', url: 'https://photooxy.com/manga-and-anime/make-naruto-logo-style-for-your-name-379.html' },
            ...
            glow: { api: 'photooxy', url: 'https://photooxy.com/logo-and-text-effects/make-smoky-neon-glow-effect-343.html' },
            sweet: { api: 'photooxy', url: 'https://photooxy.com/logo-and-text-effects/sweet-andy-text-online-368.html' },
            wood: { api: 'photooxy', url: 'https://photooxy.com/logo-and-text-effects/carved-wood-effect-online-365.html' },
            // --- TextPro API Styles ---
            neon: { api: 'textpro', url: 'https://textpro.me/create-a-futuristic-technology-neon-light-text-effect-1006.html' },
            blackpink: { api: 'textpro', url: 'https://textpro.me/create-blackpink-logo-style-online-1001.html' },
            joker: { api: 'textpro', url: 'https://textpro.me/create-joker-logo-online-free-1046.html' },
            ...
            marvel: { api: 'textpro', url: 'https://textpro.me/create-logo-style-marvel-studios-online-971.html' },
            glitch: { api: 'textpro', url: 'https://textpro.me/create-a-glitch-text-effect-online-free-1026.html' },
            water: { api: 'textpro', url: 'https://textpro.me/create-a-3d-glossy-water-text-effect-online-1066.html' },
            ...
            space: { api: 'textpro', url: 'https://textpro.me/create-space-3d-text-effect-online-985.html' },
            magma: { api: 'textpro', url: 'https://textpro.me/create-a-magma-hot-text-effect-online-1030.html' },
            sand: { api: 'textpro', url: 'https://textpro.me/sand-writing-text-effect-online-990.html' },
            cloud: { api: 'textpro', url: 'https://textpro.me/create-a-cloud-text-effect-on-the-sky-online-1004.html' },
            ...
            blood: { api: 'textpro', url: 'https://textpro.me/blood-text-on-the-frosted-glass-941.html' },
        ...
        try {
            ...
            } else { // Fallback to TextPro by default
                imageUrl = await createTextPro(selectedStyle.url, text);
            }

            if (!imageUrl) throw new Error("Image URL not found after API processing.");
